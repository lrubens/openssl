...
#define OQS_COMPILE_CFLAGS "-g -O2  -mmmx -mpopcnt -msse -msse2 -msse3 -msse4.1 -msse4.2 -mavx -mavx2 -mfma -mbmi -maes -I/usr/lib/ssl/include  -std=gnu11 -Wall -Wextra -Werror  -Wimplicit -Wunused -Wcomment -Wchar-subscripts -Wuninitialized  -Wshadow -Wformat-security -Wwrite-strings  -Wno-missing-braces -Wno-missing-field-initializers -g  -fPIC  -fvisibility=hidden  -I/home/ubuntu/liboqs/include -I.  -I/usr/lib/ssl/include  -O3  -fomit-frame-pointer  -DCONSTANT_TIME "
#define OQS_COMPILE_LDFLAGS " -L/usr/lib/ssl/lib"
...
#define OQS_ENABLE_KEM_round5_r5n1_1ccakem_0d 1
#define OQS_ENABLE_KEM_round5_r5n1_1kem_0d 1
#define OQS_ENABLE_KEM_round5_r5n1_3ccakem_0d 1
#define OQS_ENABLE_KEM_round5_r5n1_3ccakem_0smallct 1
#define OQS_ENABLE_KEM_round5_r5n1_3kem_0d 1
#define OQS_ENABLE_KEM_round5_r5n1_5ccakem_0d 1
#define OQS_ENABLE_KEM_round5_r5n1_5kem_0d 1
#define OQS_ENABLE_KEM_round5_r5nd_0kem_2iot 1
#define OQS_ENABLE_KEM_round5_r5nd_1ccakem_0d 1
#define OQS_ENABLE_KEM_round5_r5nd_1ccakem_5d 1
#define OQS_ENABLE_KEM_round5_r5nd_1kem_0d 1
#define OQS_ENABLE_KEM_round5_r5nd_1kem_4longkey 1
#define OQS_ENABLE_KEM_round5_r5nd_1kem_5d 1
#define OQS_ENABLE_KEM_round5_r5nd_3ccakem_0d 1
#define OQS_ENABLE_KEM_round5_r5nd_3ccakem_5d 1
#define OQS_ENABLE_KEM_round5_r5nd_3kem_0d 1
#define OQS_ENABLE_KEM_round5_r5nd_3kem_5d 1
#define OQS_ENABLE_KEM_round5_r5nd_5ccakem_0d 1
#define OQS_ENABLE_KEM_round5_r5nd_5ccakem_5d 1
#define OQS_ENABLE_KEM_round5_r5nd_5kem_0d 1
#define OQS_ENABLE_KEM_round5_r5nd_5kem_5d 1
